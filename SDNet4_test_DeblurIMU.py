...
def main():
        ...
        for lv in ['lv1', 'lv2', 'lv3']:
            ...
            if os.path.exists(str('./checkpoints/' + METHOD + "/encoder_" + s + "_" + lv + ".pkl")):
                encoder[s][lv].load_state_dict(
                    torch.load(str('./checkpoints/' + METHOD + "/encoder_" + s + "_" + lv + ".pkl")))
    ...
    for images_name in filenames:
        with torch.no_grad():
            ...
            images['lv1'] = transforms.ToTensor()(Image.open(images_name + '_blur_err.png').convert('RGB'))
            ...
            feature[s]['lv1'] = encoder[s]['lv1'](residual[ps]['lv1'] + residual[s]['lv2']) + feature[s]['lv2'] + \
                                feature[ps]['lv1']
            residual[s]['lv1'] = decoder[s]['lv1'](feature[s]['lv1'])
            ...
            save_images(deblurred_image.data + 0.5, images_name + '.png')
            iteration += 1
